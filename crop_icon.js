...
async function main() {
    ...
    const outputPath = 'frontend/public/favicon.png'; // Substitui o que já está na public
    const logoDestPath = 'frontend/public/logo.png'; // Pode substituir a logo principal também se servir
